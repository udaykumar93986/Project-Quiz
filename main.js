...
sample HTML code to be generated

<div id="q_1" class="row question_box">
	<p class="question">Q1.Which was not one of Voldemort's Horcruxes?</p>
	<div class="option">
		<input class="form-check-input" type="radio" name="q_1" id="option_0_0" value="0">
		<label class="form-check-label" for="option_0_0">Nagini</label>
	</div>
</div>
